...
ggplot(data, aes(x = Product)) + 
  geom_bar(fill = "red", color = "black", width = 0.3) + 
...
```
  ...
  The age range is (18-50). From the graph and table, we observe that people of age 23-28 are the most popular buyers. After age 28, the sales decrease with the decrease in age.
